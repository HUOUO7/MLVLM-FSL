...
#DATA="/data/user4/cww/Data_Construction/output7_newformat_Qwen_cww/novel_ele_10way/vanilla_ele_50000/base_all_merge_1wx12.json"
...
torchrun $DISTRIBUTED_ARGS finetune.py \
    ...
    --fp16 True \
    --fix_vit True \
    --output_dir output_qwen/0709_qwen_10way_1shot_vanillia \
    --num_train_epochs 2 \
